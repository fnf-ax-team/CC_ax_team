...
graph TD
    ...
    subgraph SUPPORT["배경교체 서포트 스킬"]
        SP1["무드분석_mood-analysis"]
        SP2["에러추적_error-tracking"]
        SP3["성능최적화_john-carmack"]
        SP4["오케스트레이션_director"]
    end
    ...
    style SUPPORT fill:#fff3e0,stroke:#ffa726
```
