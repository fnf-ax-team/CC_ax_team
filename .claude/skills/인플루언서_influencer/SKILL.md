...
4. Claude: [폴더 확인] "3장 확인! 의상은요? (텍스트 또는 이미지 폴더 경로)"

5. 사용자: (자유 입력)
   - 텍스트: "흰 티셔츠", "운동복", "원피스"
   - 폴더 경로: "D:\사진\옷\" (의상 참조 이미지)
   - 생략: "아무거나" / "알아서"

6. Claude: "어떤 느낌으로요? (표정, 구도, 장소)"
...
8. Claude: [AskUserQuestion - 클릭 선택]
   📏 비율: 9:16 / 4:5 / 1:1 / 3:4
   🔢 수량: 1장 / 3장 / 5장 / 10장
...
| 표정 | 구도 | 장소 | 의상 |
|------|------|------|------|
| 끼부리는, 도도한, 청순한 | 얼빡, 상체, 전신 | 카페, 침대, 차 안 | 흰 티, 원피스 |
| 자연스러운, 웃는, 찡그린 | 누워서, 앉아서, 서서 | 헬스장, 야외, 클럽 | 운동복, 수영복 |
| 졸린, 섹시한, 쿨한 | 옆모습, 뒷모습 | 욕실, 호텔, 거리 | 파자마, 코트 |
