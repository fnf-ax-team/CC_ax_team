...
>
> **v9.0.0: MLB 전용 프리셋 DB 연결 (`db/presets/brandcut/mlb/`)**

---

## 프리셋 참조 (Preset References)

> **MLB 전용 프리셋 위치**: `db/presets/brandcut/mlb/`
>
> 범용 프리셋(`db/presets/common/*.json`) 대신 MLB 브랜드에 최적화된 전용 프리셋 사용

| 카테고리 | 참조 파일 | 프리셋 수 | 설명 |
|----------|-----------|----------|------|
| 포즈 | `db/presets/brandcut/mlb/mlb_pose_presets.json` | 16개 | 왼팔/오른팔/왼손/오른손/왼다리/오른다리/힙 상세 |
| 표정 | `db/presets/brandcut/mlb/mlb_expression_presets.json` | 6개 | 베이스/바이브/눈/시선/입 상세, 큰 아몬드눈 필수 |
| 배경 | `db/presets/brandcut/mlb/mlb_background_presets.json` | 12개 | 지역/시간대/색감/장소/분위기/provides/supported_stances |
| 비주얼_무드 | `db/presets/brandcut/mlb/mlb_visual_mood_presets.json` | 6개 | 필름텍스처/컬러그레이딩/조명, 쿨톤 필수 |
| 촬영_세팅 | `db/presets/brandcut/mlb/mlb_camera_presets.json` | 8개 | 포즈와 1:1 매칭, f/2.8 고정 |
| 스타일링 | `db/presets/brandcut/mlb/mlb_styling_presets.json` | 5개 | 아이템/코디방법/스타일링포인트 |
| 모델 | `db/presets/brandcut/mlb/mlb_model_presets.json` | 4개 | 민족/성별/나이/헤어 |
