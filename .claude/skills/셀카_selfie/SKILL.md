...
```
db/presets/common/pose_presets.json       <- 포즈 DB (75개)
db/presets/selfie/scene_presets.json      <- 씬 DB (98개) + 레퍼런스 이미지 경로
db/presets/common/expression_presets.json <- 표정 DB (10개) + 레퍼런스 이미지 경로
