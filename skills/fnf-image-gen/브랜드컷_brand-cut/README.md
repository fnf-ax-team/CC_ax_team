...
│              │     │              │     │              │     │              │
│ Face Image   │────>│ Outfit       │────>│ Prompt       │────>│ 5-Gate       │
│ Outfit Image │     │ Analysis     │     │ Builder      │     │ Sequential   │
│ Concept      │     │ (VLM)        │     │              │     │ Check        │
└──────────────┘     └──────────────┘     └──────────────┘     └──────┬───────┘
                                                                       │
                                          ┌────────────────────────────┘
...
Analysis Results
     ...
     └──> build_brandcut_prompt()
               │
               ├── 1. Brand DNA (MLB/Discovery/etc.)
               ├── 2. Outfit Description (착장 분석 결과)
               ├── 3. Model Specification (얼굴, 체형)
               ├── 4. Concept/Mood
               ├── 5. Pose & Composition
...
```
Gate 1 (착장) FAIL → Gate 2~5 검사 안 함 → 착장 강화 재생성
Gate 2 (얼굴) FAIL → Gate 3~5 검사 안 함 → 얼굴 강화 재생성
...
```
