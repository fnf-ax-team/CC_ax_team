...
2. Claude: "얼굴 이미지 폴더 경로 알려주세요! (2~3장, 정면 얼빡이 좋아요)
   예: D:\사진\얼굴\ 또는 C:\Users\...\Downloads\"

3. 사용자: "D:\사진\model1\" (폴더 또는 파일 경로)

4. Claude: [폴더 확인 → 이미지 로드 → 성별 확인]
   - 이미지 발견: "3장 확인했어요!" → 5번으로
   - 이미지 없음: "이미지가 없어요. 다른 경로 알려주세요"
   - 성별 애매: "성별 선택해주세요: 여자/남자"

5. Claude: "이미지 만들게요! 옵션 선택해주세요:

   📷 스타일
   • 끼부리는 셀카 (폰 O) - 아이폰 들고 찍는 셀카
   • 끼부리는 셀카 (폰 X) - 폰 없이 셀카 느낌, 카메라 응시
   • 자연스러운 셀카 (폰 O) - 폰 들고 대충 찍은 듯
   • 자연스러운 셀카 (폰 X) - 폰 없이 자연스럽게
   • 남이 찍어준 사진 - 누군가 찍어준 자연스러운 사진
   • 거울 셀카 - 거울 앞에서 전신/반신 (폰 보임)
...
| 조합 | 설명 |
|------|------|
| 끼부리는 셀카 (폰 O) + 얼빡 + 카페 | 전형적인 인스타 셀카 (폰 보임) |
| 끼부리는 셀카 (폰 X) + 얼빡 + 침대 | 인스타 셀카 느낌 (폰 안 보임) |
| 자연스러운 셀카 (폰 X) + 얼빡 + 침대 | 집에서 대충 찍은 느낌 |
| 거울 셀카 + 전신 + 헬스장 | 오오티디 거울샷 (폰 보임) |
| 남이 찍어준 + 상체 + 야외 | 남친이 찍어준 느낌 |
| 남이 찍어준 + 전신 + 카페 | 프로필 사진 느낌 |
| 끼부리는 셀카 (폰 O) + 상체 + 차 안 | 럭셔리한 느낌 (폰 보임) |
